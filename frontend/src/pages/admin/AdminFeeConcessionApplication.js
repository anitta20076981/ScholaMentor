...
function AdminFeeConcessionApplication() {
  ...
  useEffect(() => {
    const fetchFeeConcessionApplication = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/admin/get-all-fee-concession-applications`);
            ...
            <table style={tableStyle}>
              <thead>
                <tr>
                  ...
                  <th style={thStyle}>Concession Requested</th>
              ...
              <tbody>
                {currentScholarshipApplication.length > 0 ? (
                  currentScholarshipApplication.map((application, index) => (
                    ...
                    <td style={tdStyle}>{application.concession_requested}</td>
                    <td style={tdStyle}>{application.course}</td>
                    <td style={tdStyle}>
                      <span
                        style={{
                          padding: "2px 6px",        
                    ...
                    <button
                        ...
                        onClick={() => navigate(`/admin/view-fee-concession-application/${application.id}`)}
...
export default AdminFeeConcessionApplication;
