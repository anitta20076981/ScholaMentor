    ...
    const fetchRecommended = async () => {
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API_URL}/api/sponsor/get-approved-requested/${sponsorId}`
        );
...
export default ApprovedSponsorship;
